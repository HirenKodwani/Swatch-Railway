...
class _WorkerRatingScreenState extends State<WorkerRatingScreen>
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    _buildStarRow(_avgOverall, size: 18, color: Colors.amber),
                    const SizedBox(height: 4),
                    Text(
  ...
  Widget _buildRatingBadge(String type) {
    final isOfficial = type == 'Official';
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
      decoration: BoxDecoration(
        color: (isOfficial ? Colors.purple : Colors.blue).withValues(
          alpha: 0.1,
        ),
        borderRadius: BorderRadius.circular(4),
        border: Border.all(
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 11,
          fontWeight: FontWeight.w600,
          color: isOfficial ? Colors.purple : Colors.blue,
        ),
      ),
    );
  }
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                _badge(
                  rating.raterType,
                  rating.raterType == 'Official' ? Colors.purple : Colors.blue,
                ),
                if (rating.isRandomInspection)
