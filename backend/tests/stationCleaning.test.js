...
const stationCleaningPermissions = {
  ...
  VIEW_RUNS: { VIEW: makeAllRolesList(['COMPANY_MASTER', 'RAILWAY_MASTER', 'ADMIN', 'RAILWAY_ADMIN', 'STATION_MASTER', 'CONTRACTOR_ADMIN', 'RAILWAY_SUPERVISOR', 'PLATFORM_MASTER', 'CONTRACTOR_SUPERVISOR']) },
...
describe('Authorization middleware - station cleaning endpoints', () => {
  ...
  const permConfigs = {
    ...
    'VIEW_RUNS': withSA(['COMPANY_MASTER', 'RAILWAY_MASTER', 'ADMIN', 'RAILWAY_ADMIN', 'STATION_MASTER', 'CONTRACTOR_ADMIN', 'RAILWAY_SUPERVISOR', 'PLATFORM_MASTER', 'CONTRACTOR_SUPERVISOR']),
    ...
    'MANAGE_PEST_CONTROL': withSA(['COMPANY_MASTER', 'RAILWAY_MASTER', 'ADMIN', 'RAILWAY_ADMIN', 'STATION_MASTER', 'CONTRACTOR_ADMIN']),
    'VIEW_PEST_CONTROL': withSA(['COMPANY_MASTER', 'RAILWAY_MASTER', 'ADMIN', 'RAILWAY_ADMIN', 'STATION_MASTER', 'CONTRACTOR_ADMIN', 'RAILWAY_SUPERVISOR', 'PLATFORM_MASTER', 'CONTRACTOR_SUPERVISOR']),
    'MANAGE_GARBAGE': withSA(['COMPANY_MASTER', 'RAILWAY_MASTER', 'ADMIN', 'RAILWAY_ADMIN', 'STATION_MASTER', 'CONTRACTOR_ADMIN']),
    'VIEW_GARBAGE': withSA(['COMPANY_MASTER', 'RAILWAY_MASTER', 'ADMIN', 'RAILWAY_ADMIN', 'STATION_MASTER', 'CONTRACTOR_ADMIN', 'RAILWAY_SUPERVISOR', 'PLATFORM_MASTER', 'CONTRACTOR_SUPERVISOR']),
  };
...
describe('WORKER has SUBMIT_TASKS and VIEW_TASKS but not manage perms', () => {
  const managePerms = ['MANAGE_AREAS', 'MANAGE_CONTRACTORS', 'MANAGE_SCHEDULES', 'MANAGE_RUNS',
    ...
    'MANAGE_PEST_CONTROL', 'MANAGE_GARBAGE'];
