...
router.post('/:formId/approve-manpower', verifyToken, premisesFormController.approveManpower);
router.put('/:formId/approve-manpower', verifyToken, premisesFormController.approveManpower);

router.put('/:formId/save-scoring-draft', verifyToken, premisesFormController.saveScoringDraft);
router.put('/:formId/scoring/draft', verifyToken, premisesFormController.saveScoringDraft);

router.post('/:formId/submit-scoring', verifyToken, premisesFormController.submitScoring);
router.post('/:formId/scoring', verifyToken, premisesFormController.submitScoring);
router.put('/:formId/scoring', verifyToken, premisesFormController.submitScoring);

router.post('/:formId/accept-rating', verifyToken, premisesFormController.acceptRating);
...
router.post('/:formId/reject', verifyToken, premisesFormController.reject);
